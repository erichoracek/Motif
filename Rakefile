...
BUILD_FLAGS_TEST_IOS = "test -scheme '#{LIBRARY_NAME}-iOS' -sdk #{TEST_SDK} -destination 'platform=iOS Simulator,OS=9.0,name=iPhone 6s' " + BUILD_FLAGS
BUILD_FLAGS_TEST_OSX = "test -scheme '#{LIBRARY_NAME}-OSX' " + BUILD_FLAGS
BUILD_FLAGS_BUILD_CLI = "build -scheme #{SCHEME_CLI} " + BUILD_FLAGS
BUILD_FLAGS_BUTTONS_EXAMPLE = "build -scheme '#{SCHEME_BUTTONS_EXAMPLE}' " + BUILD_FLAGS
BUILD_FLAGS_SWIFT_BUTTONS_EXAMPLE = "build -scheme '#{SCHEME_SWIFT_BUTTONS_EXAMPLE}' " + BUILD_FLAGS
BUILD_FLAGS_DYNAMIC_THEMES_EXAMPLE = "build -scheme '#{SCHEME_DYNAMIC_THEMING_EXAMPLE}' " + BUILD_FLAGS
BUILD_FLAGS_SCREEN_BRIGHTNESS_EXAMPLE = "build -scheme '#{SCHEME_SCREEN_BRIGHTNESS_THEMING_EXAMPLE}' " + BUILD_FLAGS
