...
- (void)testThemeClassEquality
{
    ...
    NSString *name = @"name";
    AUTThemeClass *class1 = [[AUTThemeClass alloc] initWithName:name propertiesConstants:@{key: constant1}];
    AUTThemeClass *class2 = [[AUTThemeClass alloc] initWithName:name propertiesConstants:@{key: constant2}];
...
- (void)testThemeClassNameInequality
{
    ...
    AUTThemeClass *class1 = [[AUTThemeClass alloc] initWithName:name1 propertiesConstants:@{}];
    NSString *name2 = @"name2";
    AUTThemeClass *class2 = [[AUTThemeClass alloc] initWithName:name2 propertiesConstants:@{}];
