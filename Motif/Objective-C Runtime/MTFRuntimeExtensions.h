...
typedef enum {
     ...
     */
    mtf_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    mtf_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    mtf_propertyMemoryManagementPolicyCopy
} mtf_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #mtf_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    mtf_propertyMemoryManagementPolicy memoryManagementPolicy;
