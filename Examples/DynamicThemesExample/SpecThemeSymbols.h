// WARNING: Do not modify. This file is machine-generated from 'SpecTheme.json'.
...
extern NSString * const SpecThemeName;

extern const struct SpecThemeClassNames {
    __unsafe_unretained NSString *Spec;
} SpecThemeClassNames;
