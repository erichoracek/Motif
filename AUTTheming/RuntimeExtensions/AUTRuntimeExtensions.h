...
typedef enum {
     ...
     */
    aut_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    aut_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    aut_propertyMemoryManagementPolicyCopy
} aut_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #aut_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    aut_propertyMemoryManagementPolicy memoryManagementPolicy;
